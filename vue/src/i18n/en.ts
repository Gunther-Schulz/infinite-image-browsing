...
You can specify which snapshot to restore to when starting IIB in the global settings page, or restore to the last workspace state before closing.`,
  ...
  noPositivePromptToCopy: 'This file has no positive prompt to copy',
  promptCopyFailed: 'Could not read this file\'s generation info',
  ...
  metaSectionTiming: 'Timing',
  metaSectionEverythingElse: 'Everything else',
  metaShowAll: 'Show all',
  metaHide: 'Hide',
  ...
  launch: 'Launch',
  walkMode: 'Use Walk mode to browse files',
  launchFromNormalAndFixed: 'Use Normal / Fixed mode to browse files',
  recent: 'Recent',
